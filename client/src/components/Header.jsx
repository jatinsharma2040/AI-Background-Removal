  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10
        ...
        <div>
            ...
            <br className='max-sm:hidden'/>Perfect for e-commerce, profile pictures, or creative projects. Just upload and download!</p>

            <div>
            <input type='file' name='' id='upload1' hidden/>
            <label className='inline-flex gap-3 px-8 py-3.5 rounded-full
